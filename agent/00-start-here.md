...
你推门进来的地方，是一本还在写作中的书。它的主角是一个叫 pi-agent-core 的小库：一个被做成库的 agent 循环——克制、无状态、只说事件。这本书想做的事只有一件：陪你把它的源码从头到尾走一遍，走到你能闭上眼睛画出它的形状。
...
悬浮到任意标题上，它的末尾会浮现一枚小圆环——点它，这一节的链接就进了地址栏，可以直接分享给别人。
